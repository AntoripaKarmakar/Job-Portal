...
<nav class="navbar navbar-expand-lg shadow-sm fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold" href="Landing.jsp">
        ...
        <div class="collapse navbar-collapse ms-auto" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item"><a href="RecruiterSignup.jsp#jobForm" class="btn btn-success btn-sm px-4 ms-2 btn-signup">Signup</a></li>
            </ul>
        </div>
    </div>
</nav>
