    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse ms-auto" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item"><a href="JobListServlet?dest=seeker" class="nav-link fw-semibold">Find Jobs</a></li>
                <li class="nav-item"><a href="MyApplicationServlet" class="nav-link fw-semibold">My Applications</a></li>
