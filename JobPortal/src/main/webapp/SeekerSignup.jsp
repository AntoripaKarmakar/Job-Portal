    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse ms-auto" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item"><a href="SeekerLogin.jsp" class="nav-link fw-semibold">Post Jobs</a></li>
        ...
        <div class="col-lg-10">
            <div class="row signup-container">
                ...
                <div class="col-lg-5 brand-section">
                    ...
                    <h2>CarrierNest</h2>
                    <p>Sign Up and Begin Your Journey of Finding and Applying Your Dream Job.</p>
                </div>

                <!-- Right: Signup Form -->
                <div class="col-lg-7 form-section">
                    <h3 class="fw-bold mb-4">Create Seeker Account</h3>
                    <form action="SignupServlet?role=seeker" method="POST">
                        <div class="row">
                        ...
                        <button type="submit" class="btn btn-success w-100 btn-signup">SignUp</button>
                        <div class="text-center mt-3">
                            <small class="text-muted">Already have an account? <a href="SeekerLogin.jsp" class="text-primary">Login</a></small>
                        </div>
                    </form>
                </div>
