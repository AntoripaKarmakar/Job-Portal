...
<head>
<meta charset="UTF-8">
<title>CarrierNest - Admin Login</title>
...
<nav class="navbar navbar-expand-lg shadow-sm fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="Landing.jsp" style="color: white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="me-2">
        ...
        <div class="collapse navbar-collapse ms-auto" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a href="AdminLogin.jsp" class="btn btn-success btn-sm px-4 ms-2 rounded-pill">Login</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="col-lg-10">
            <div class="row signup-container">
                ...
                <div class="col-lg-6 brand-section">
                    ...
                    <h2>CarrierNest</h2>
                    <p>Join CarrierNest and start hiring smarter with powerful tools for recruiters.</p>
                </div>
