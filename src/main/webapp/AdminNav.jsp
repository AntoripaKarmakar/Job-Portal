    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                <li class="nav-item"><a href="JobListServlet?dest=admin" class="nav-link">All Jobs</a></li>
                <li class="nav-item"><a href="JobListServlet?dest=adminverified" class="nav-link">Verified Jobs</a></li>
