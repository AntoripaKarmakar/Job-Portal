                ...
                <div class="card shadow-sm h-100 job-card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                        	<%-- <a href="NewApplicationServe?jid=<%= job.getJid() %>"><button class="btn btn-primary btn-sm px-4">Apply</button></a> --%>
                        	<a href="JobDetailsServe?dest=seeker&jid=<%= job.getJid() %>#apply"><button class="btn btn-primary btn-sm px-4">Apply</button></a>
                            <a href="JobDetailsServe?dest=seeker&jid=<%= job.getJid() %>" class="text-primary fw-semibold">
